...
{#if !appState.isLoggedIn}
  <div class="flex w-full flex-col items-center justify-center gap-4 p-20">
    {#if loggedOutMessage}
      <h1
        class="flex w-fit items-center justify-center rounded border bg-green-500 p-2 text-center text-2xl text-white"
      >
        You have been logged out!
      </h1>
    {/if}
    <div class="flex w-full justify-center">
      <div class="w-full max-w-md rounded border p-5 hover:border-plw-red">
        <h1 class="mb-2 text-2xl">
          <UserLock class="inline-block" />
          Login or sign up to access the dashboard
        </h1>
        <div class="flex w-full flex-col gap-2">
          <a href="/login" class="w-full rounded-md bg-plw-red p-1.5 text-center text-white"
            >Login</a
          >
          <a href="/signup" class="w-full rounded-md bg-plw-red p-1.5 text-center text-white"
            >Sign up</a
          >
          <Separator class="mt-4" />
          <a href="/" class="w-full rounded-md bg-plw-red p-1.5 text-center text-white"
            ><House class="inline-block" /> Landing</a
          >
        </div>
      </div>
    </div>
